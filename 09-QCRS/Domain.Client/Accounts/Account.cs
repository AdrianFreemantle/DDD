...
namespace Domain.Client.Accounts
{
    ...
    {       
        ...
        public static Account Open(ClientId clientId, AccountNumber accountNumber)
        {
            ...
            account.RaiseEvent(new AccountOpened(accountNumber, clientId));
        ...
        private void SetAccountStatus(AccountStatusType status)
        {
            ...
            RaiseEvent(new AccountStatusChanged(Identity, clientId, new AccountStatus(status)));
        }
        ...
        public void RegisterPayment(BillingResult billingResult)
        {
            ...
            RaiseEvent(new AccountBilled(Identity, clientId, recency.FromBillingResult(billingResult)));
